...
<%--            &lt;%&ndash;            <tr>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>1</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>Боруто. Наруто: Следующее поколение</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>Japan</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>2017</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>Adventure, fantasy</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>18</td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    Встречайте новое поколение ниндзя! История Наруто подошла к концу,&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    он исполнил свою мечту и стал Хокаге. Теперь в центре событий его сын по имени Боруто,&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    который избрал для себя совсем иной путь. Однако для начала ему следует завести друзей и&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    таки выпуститься из Академии, чтобы стать настоящим ниндзя. Новая история – наследие «Наруто»!&ndash;%&gt;--%>
<%--            &lt;%&ndash;                </td>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <td class="table-actions">&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    <button class="btn btn-outline-success">&ndash;%&gt;--%>
<%--            &lt;%&ndash;                        <i class="fa-regular fa-pen-to-square"></i>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                        Edit&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    </button>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                    <button class="btn btn-outline-danger">&ndash;%&gt;--%>
